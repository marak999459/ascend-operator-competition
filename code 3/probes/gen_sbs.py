...
SHAPES = {
    ...
    # P111：把"每行 token 数固定 8192、只改稀疏粒度"的阶梯补齐 ⇒ sbs 探针的四级桶
    #   （0 / 1 / 2 / 3）在同工作量上逐档可验，平台读数才有对照表。
    'p1s16': (1, 4, 8192, 4, 512, 16, 3, 512, 512),
    'p1s32': (1, 4, 8192, 4, 512, 32, 3, 256, 256),
    'p1s64': (1, 4, 8192, 4, 512, 64, 3, 128, 128),
    'p1s128': (1, 4, 8192, 4, 512, 128, 3, 64, 64),
